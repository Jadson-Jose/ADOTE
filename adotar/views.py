...
def processa_pedido_adocao(request, id_pedido):
    ...
    if status == "A":
        pedido.status = 'AP'
        string = '''Olá, a sua adoção foi aprovada com sucesso....'''
    elif status == "R":
        string = '''Infelizmente a sua adoção foi recusada!!'''
        pedido.status = "R"
    ...
    messages.add_message(request, constants.SUCCESS, 'Pedido de adoção precessado com sucesso.')
